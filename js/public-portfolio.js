(() => {
  ...
  style.textContent = `
    ...
    @media(max-width:800px){.hero-art:before{width:360px;height:360px}.hero-art:after{right:0;top:4%;font-size:.5rem}.case-art{height:300px}.case-dialog>.case-art{height:250px}.case-materials{grid-template-columns:1fr}.case-material,.case-material img{min-height:190px}}
  `;
